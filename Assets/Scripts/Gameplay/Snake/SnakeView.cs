...
namespace SnakeGame.Gameplay.View
{
    public class SnakeView : MonoBehaviour
    {
        ...
        // Але для цілей тестового завдання цього достатньо
        // Можна зробити опимізацію, щоб не повертати сегменти постійно в пул а переміщувати існуючі
        // Також тут постійно створюються нові об'єкти голови і хвоста, що теж не дуже оптимально
        // Але це можна виправити, якщо зробити їх теж з пулу. Тут це залишено для демонстрації фабрики з пулом і без
